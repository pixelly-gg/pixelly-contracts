 ...
 */
contract PixellyAuction is ERC721Holder, OwnableUpgradeable, ReentrancyGuardUpgradeable {
 ...
 */
    ...
    function placeBid(
        ...
        require(
            ...
            "ERC20 method used for TENET auction"
        );
        ...
        nonReentrant
    {
        ...
        IPixellyMarketplace marketplace = IPixellyMarketplace(
        ...
        emit AuctionResulted(
            ...
            _winner,
            _payToken,
            IPixellyMarketplace(_marketplace).getPrice(
                _payToken
            ),
            _winningBid
        );
    ...
    function _createAuction(
        ...
        // Transfer the NFT to the Pixelly contract to be held in escrow
        IERC721(_nftAddress).safeTransferFrom(
            IERC721(_nftAddress).ownerOf(_tokenId),
            address(this),
            _tokenId
