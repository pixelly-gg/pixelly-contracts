...
import "./PixellyArtTradable.sol";

contract PixellyArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new PixellyArtTradable contract
        ...
        returns (address)
    {
        ...
        PixellyArtTradable nft = new PixellyArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
