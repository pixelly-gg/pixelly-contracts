...
import "./PixellyNFTTradablePrivate.sol";

contract PixellyNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Pixelly auction contract address;
    address public auction;

    /// @notice Pixelly marketplace contract address;
    address public marketplace;

    /// @notice Pixelly bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new PixellyNFTTradable contract
        ...
        returns (address)
    {
        ...
        PixellyNFTTradablePrivate nft = new PixellyNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing PixellyNFTTradable contract
    ...
    /// @notice Method for disabling existing PixellyNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
