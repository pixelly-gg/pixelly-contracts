...
/**
 * @title PixellyNFTTradable
 * PixellyNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract PixellyNFTTradable is ERC721, Ownable {
