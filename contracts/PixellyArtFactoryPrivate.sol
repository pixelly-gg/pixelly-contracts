...
import "./PixellyArtTradablePrivate.sol";

contract PixellyArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new PixellyArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        PixellyArtTradablePrivate nft = new PixellyArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing PixellyArtTradable contract
    ...
    /// @notice Method for disabling existing PixellyArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
