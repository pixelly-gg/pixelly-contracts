...
/**
 * @title PixellyArtTradablePrivate
 * PixellyArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract PixellyArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Pixelly Marketplace contract
    address marketplace;
    // Pixelly Bundle Marketplace contract
    ...
    {
        // Whitelist Pixelly marketplace, bundle marketplace contracts for easy trading.
