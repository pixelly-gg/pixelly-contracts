...
/**
 * @title PixellyNFTTradablePrivate
 * PixellyNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract PixellyNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist Pixelly contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Pixelly auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Pixelly contracts to enable gas-less listings.
     */
