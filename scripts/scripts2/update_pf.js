async function main(network) {
  ...
  const AGORA_ADDRESS_REGISTRY = "0x55b82Af8E85A17D62F140f01e9b6c457519BD484";

  const { WRAPPED_ETH_MAINNET } = require("../constants");

  const art = await (await ethers.getContractFactory("AgoraNFTFactory")).attach(
    "0xBBefe6432A7A772DB0F282361E3506764d8b8212"
  );

  const artPrivate = await (
    await ethers.getContractFactory("AgoraNFTFactoryPrivate")
